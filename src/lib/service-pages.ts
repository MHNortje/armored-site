...
export const SERVICE_PAGES: readonly ServicePage[] = [
  ...
  },
  {
    ...
    image: "/brand/cnc-plasma-low-angle-v1-hd.webp",
    imageAlt: "Low-angle view of an industrial CNC plasma cutter profiling thick steel plate with sparks ricocheting across the cutting bed",
  ...
  },
  {
    ...
    image: "/brand/welding-fixture-table-v1-hd.webp",
    imageAlt: "Professional fabricator welding a clamped structural steel frame on a precision fixture table with sparks falling across the work surface",
  ...
  },
  {
    ...
    image: "/brand/machining-single-column-mill-v1-hd.webp",
    imageAlt: "Single-column vertical milling machine cutting a clamped steel component with curled metal chips flying in the Armored Pangolin workshop",
